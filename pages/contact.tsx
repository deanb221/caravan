            ...
            <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        We serve all of Northern Ireland including Belfast, Derry/Londonderry, 
                        Antrim Coast, Giant's Causeway, and surrounding areas.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
                ...
                <p className="mt-4 text-sm text-gray-600">
                  For urgent inquiries outside business hours, please email us and we'll respond 
                  as soon as possible.
                </p>
              </div>
            </div>
